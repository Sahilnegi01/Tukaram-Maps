...
export default function EstablishmentDetails(){
  ...
  return <main className="recordPage">
    ...
    <footer className="recordFooter"><span>© {new Date().getFullYear()} Tukaram Maps</span><nav><a href="#terms">Terms</a><a href="http://localhost:8001/docs">API Docs</a><a href="mailto:contact@example.com">Contact</a></nav></footer>
  </main>;
}
